          ...
          child: Column(
            ...
            children: [
              ...
              _buildCategoryRecipeCard(
                ...
                "Chicken Wrap",
                "1.5 hours - Medium",
                "assets/images/Easy Chipotle Ranch Grilled Chicken Burrito.jpg",
              ),
              const SizedBox(height: 20),
              _buildCategoryRecipeCard(
                context,
                "Pasta",
                "1 hour - Easy",
                "assets/images/Spicy Tomato Pasta.jpg",
              ),
              const SizedBox(height: 20),
              _buildCategoryRecipeCard(
                context,
                "Daal bhat",
                "30 minutes - Easy",
                "assets/images/Red Lentil Curry (vegan) _ Masoor Dal.jpg",
              ),
